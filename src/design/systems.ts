...
export const DESIGN_SYSTEMS: Record<string, DesignSystem> = {
  "1": { id: "1", key: "axis", label: "1. AXIS — 밝은 코발트 · 모던 프로페셔널 (웹/대시보드, 토큰형)", css: AXIS_CSS, guide: AXIS_GUIDE },
  ...
  "4": { id: "4", key: "atelier", label: "4. ATELIER — 다크 에디토리얼 · 골드+세리프 (고급/차분)", css: ATELIER_CSS, guide: ATELIER_GUIDE },
};
